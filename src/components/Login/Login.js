                ...
                <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:text-gray-100 border">
                    ...
                    <form onSubmit={handleLogIn} action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                        ...
                        <div className="space-y-1 text-sm">
                            ...
                            <input type="password" name="password" id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md border border-gray-700 text-black focus:border-violet-400" />
                    ...
                    <p className="text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account?
                        <Link rel="noopener noreferrer" to="/register" className="underline text-blue-500">Sign up</Link>
                    </p>
                </div>
            </div>
            <div></div>
